...
- [Admin bootstrap](admin-bootstrap.md) — admin role granted only to ilmabiomedical@gmail.com at first login; all other users get the User role; extra admins via SQL.
